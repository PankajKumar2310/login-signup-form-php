    ...
    <div className='bg-white p-3  rounded w-50 mb-5'>
        <form action="">
         ...
         <button className='btn btn-success mt-2'>Sign In</button>
          ...
          <p className='mt-3'>you don't have a account ??</p>
          <Link to='/sign-up' className=' text-decoration-none bg-transparent border-0 p-2 mt-2 .text-primary' >Create Account</Link>
          </div>
        </form>
    </div>
   </div>
